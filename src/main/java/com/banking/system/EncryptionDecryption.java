...
public class EncryptionDecryption {
    ...
    public PublicKey readPublicKeyFromMod(String VPA_RSA_MODULUS, String VPA_RSA_EXPONENT) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public PrivateKey readPrivateKeyFromMod(String VPA_RSA_MODULUS, String VPA_RSA_PRIVATE_KEY_D) throws NoSuchAlgorithmException, InvalidKeySpecException {
        byte[] modulusBytes = Base64.getDecoder().decode(VPA_RSA_MODULUS);
